...
from app import User, SavedRecipe, PasswordResetToken, PasswordResetRequestLog  # type: ignore
...
class TestPasswordResetRequestLogModel:
    ...
    def test_password_reset_request_log_multiple_entries(self, client):
        ...
        with client.application.app_context():
            log_entry1 = PasswordResetRequestLog(
                email='user1@example.com',
                ip='192.168.1.1'
            )
            log_entry2 = PasswordResetRequestLog(
