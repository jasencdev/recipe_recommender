...
def select_features(recipes, interactions):
    ...
    # Select the most important features (including original recipe ID)
    selected_columns = [
    ...
    # Rename 'id' to 'food_recipe_id' for clarity
    selected_features = selected_features.rename(columns={"id": "food_recipe_id"})
